...
To build the final jar and optimize the spakeymsuaa application for production, run:
...
[Using UAA for Microservice Security]: https://www.jhipster.tech/documentation-archive/v6.9.1/using-uaa/[Using JHipster in development]: https://www.jhipster.tech/documentation-archive/v6.9.1/development/
