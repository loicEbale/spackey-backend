...
class ProductGatlingTest extends Simulation {
    ...
    val authorization_header = "Basic " + Base64.getEncoder.encodeToString("spakeymsproductapp:bXktc2VjcmV0LXRva2VuLXRvLWNoYW5nZS1pbi1wcm9kdWN0aW9uLWFuZC10by1rZWVwLWluLWEtc2VjdXJlLXBsYWNl".getBytes(StandardCharsets.UTF_8))
    ...
    val scn = scenario("Test the Product entity")
        ...
        .formParam("client_id", "spakeymsproductapp")
        ...
        .repeat(2) {
            ...
            .get("/services/spakeymsproduct/api/products")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new product")
            .post("/services/spakeymsproduct/api/products")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "product_id":null
                , "product_name":"SAMPLE_TEXT"
                , "product_ref":"SAMPLE_TEXT"
                , "product_version":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
            ...
            .repeat(5) {
                ...
                .get("/services/spakeymsproduct${new_product_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created product")
            .delete("/services/spakeymsproduct${new_product_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
