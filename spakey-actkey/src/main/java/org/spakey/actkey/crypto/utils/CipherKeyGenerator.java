package org.spakey.actkey.crypto.utils;
...
import org.spakey.actkey.crypto.CipherConstants;
import org.spakey.actkey.crypto.KeyGenerationException;
import org.spakey.actkey.crypto.impl.RawRSAKey;
...
public final class CipherKeyGenerator {
	...
	/**
	 * Generates an AES secret key and write it in a file
	 * Function uses KeyGenerator Class from javax.crypto
	 * 
	 */
